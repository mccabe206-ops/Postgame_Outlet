...
real markdown. The Chargers lost 14–26 to Las Vegas in a game the box says was close (310 yards to
305), but they gave it away three times and never led, scoring nothing in either the first or
fourth quarter. Justin Herbert was awful for a second week running, and the offense as a whole
"looked horrible" — much of it play-calling — with no rhythm and no answers. Just as concerning,
the defense got rolled on again: two weeks in a row against below-average offenses (Arizona, then
Las Vegas) on what has been the league's weakest schedule so far. That combination — a floundering
offense and a defense that isn't holding up against soft competition — is why the number comes down
hard across the board.

## What changed — Week 2 2026

- **QB Herbert +3.0 → +1.5:** an awful second straight game. There's no way to grade him higher
  than 1.5 right now — a serious rethink, not a panic cut.
- **Offense 0.0 → −0.5:** the offense looked horrible again, largely on play-calling.
- **Defense +0.5 → −1.0 (−1.5):** got run on for a second straight week vs two below-average
  offenses on the softest schedule in the league. May be a slight overreaction, but warranted on
  the results.
- New total: **+3.5 → 0.0.**
